...
all_tests.out: obj/cp_collision.o obj/sprite.o obj/tile.o obj/image.o obj/cp_renderer.o obj/camera.o obj/game_object.o obj/main_loop.o obj/file.o obj/manager.o obj/asset_manager.o obj/video_service_mock.o obj/file_service.o obj/utils.o obj/test/collision_test.o obj/test/utils_test.o obj/test/renderer_test.o obj/test/file_test.o obj/test/data_tree_test.o obj/test/assets_file_test.o obj/test/test_utils.o src/test/gtest_main.cpp
